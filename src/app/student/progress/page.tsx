                ...
                <div className="flex flex-col flex-grow">
                    ...
                    <main className="flex-grow p-6 flex flex-col items-center">
                        {isAuthenticated === null ? (
                            ...
                            <h1 className="text-2xl text-black font-bold mb-4">Welcome to Your Progress</h1>
                        ) : (
                            <p className="text-red-600 font-bold">You are not authenticated. Redirecting to login...</p>
                        )}
                    </main>
                </div>
            </div>
